...
$(BINARYDIR)/startup_stm32f100xb.o : $(BSP_ROOT)/STM32F1xxxx/StartupFiles/startup_stm32f100xb.c $(all_make_files) |$(BINARYDIR)
	$(CC) $(CFLAGS) -c $< -o $@ -MD -MF $(@:.o=.dep)
...
$(BINARYDIR)/stm32_tm1637.o : Src/stm32_tm1637.c $(all_make_files) |$(BINARYDIR)
	$(CC) $(CFLAGS) -c $< -o $@ -MD -MF $(@:.o=.dep)
